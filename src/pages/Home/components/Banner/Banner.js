        ...
        <div class="hero " >
            <div class="hero-content flex-col lg:flex-row-reverse text-black flex">
                ...
                <div className='flex-auto lg:w-1/2 px-5 text-start '>
                    ...
                    <p class="py-6 text-start">Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
