  ...
  return (
    <div className="my-12">
      ...
      <div
        ...
        data-aos-delay="400"
        className={toggle === true ? "bg-base-100 shadow-xl p-8 md:mx-20 lg:mx-36 rounded" : "bg-slate-600 shadow-xl p-8 md:mx-20 lg:mx-36 rounded"}
      >
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 justify-items-center gap-5">
          <div className="card w-80">
            <div className="card-body">
              ...
              <p className={toggle === true ? "text-black" : "text-white"}>If a dog chews shoes whose shoes does he choose?</p>
            </div>
          </div>
          <div className="card w-80">
            <div className="card-body">
