                                ...
                                <div className="card  w-full max-w-sm shadow-2xl bg-gradient-to-r from-cyan-500 to-blue-500">
                                    ...
                                    <div className="card-body">
                                        <div className="flex items-center space-x-6 ">
                                            <div class="shrink-0 ">
                                                <img class="h-16 w-16 object-cover rounded-full " src={a.img} alt="Current profile photo" />
                                            </div>
                                        </div>
                                        ...
                                        <p className="p-2">
                                            Contact Number: <span className="font-bold"> {a?.number}</span>
                                        </p>
                                        <p className="p-2">
                                            Address: <span className="font-bold"> {a?.address}</span>
                                        </p>
                                        <Link to={'/userData'}>
