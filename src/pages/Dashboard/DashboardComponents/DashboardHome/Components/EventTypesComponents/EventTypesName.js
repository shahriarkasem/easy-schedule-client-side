    ...
    return (
        <div className='my-20'>
            <div className='flex flex-col md:flex-row justify-start my-20 items-center'>
                <button onClick={() => window.history.back()} className='btn btn-outline btn-primary'>Back</button>
                <h4 className='text-center w-full font-semibold text-2xl mt-5 md:mt-0'>Create New Event Type</h4>
            </div>
            ...
            <div className='flex flex-col md:flex-row justify-between items-center my-20'>
                <div className='flex flex-row items-center'>
                    ...
                    <div className="pl-4 md:pl-8">
                        ...
                        <p>Host an event with another person and let invitees pick a time when you're all available.</p>
                    </div>
                </div>
                <div className="flex md:justify-end w-full md:w-fit">
