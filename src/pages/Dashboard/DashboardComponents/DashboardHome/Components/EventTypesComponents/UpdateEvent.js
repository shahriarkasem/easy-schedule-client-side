...
const UpdateEvent = ({eventLocation, setEventLocation, description, setDescription, eventDate, setEventDate, eventDuration, setEventDuration, eventName, setEventName, eventTime, setEventTime, eventType, setEventType, maxInvite, setMaxInvite, setEditEvent, editEvent, eventId, refetch}) => {
  ...
  const navigate = useNavigate('');
    ...
    axios.patch(`https://easyscheduler24.herokuapp.com/update/event/${eventId}`,
    {  eventName,
      eventDate,
      eventTime,
      eventDuration,
    ...
    if (res.status === 200) {
        ...
        setEditEvent(null);
        <label for="edit-event-modal" className="cursor-pointer">
      </label>
        refetch();
    }
}).catch((error) => {
  ...
  return (
    <div className="">
      ...
      <div className="flex flex-col md:flex-row justify-start my-10 items-center pb-3 md:pb-5 border-b-2 drop-shadow-xl">
        <label for="edit-event-modal" onClick={()=>setEditEvent(null)} className="btn btn-outline btn-primary cursor-pointer">
        Back
            </label>
      ...
      <div className="border-2 rounded-md border-sky-800">
        ...
        <div className="pl-0 md:pl-10 my-10 md:my-10 m-1">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div class="form-control w-full max-w-md mt-3 md:mt-5" onChange={handleEventName}>
              <label class="label">
            ...
            <div class="form-control w-full max-w-md mt-3 md:mt-5" onChange={handleDate}>
              <label class="label">
            ...
            <div class="form-control w-full max-w-md mt-3 md:mt-5" onChange={handleTime}>
              <label class="label">
            ...
            <div class="form-control w-full max-w-md mt-3 md:mt-5" onChange={handleDuration}>
              <label class="label">
            ...
            <div class="form-control w-full max-w-md mt-3 md:mt-5" onChange={handleDescription}>
              <label class="label">
                <span class="label-text font-semibold">
            ...
            {
                maxInvite && <div class="form-control w-full max-w-md mt-3 md:mt-5" onChange={handleMaxInvite}>
                <label class="label">
                  <span class="label-text font-semibold">
                    Max invitees in a spot
                  </span>
                </label>
                <input value={maxInvite}
                  type="number"
                  placeholder=""
                  class="input input-bordered w-full max-w-md"
          ...
          <div className="mt-[-32px] ml-3">
            <label for="edit-event-modal" onClick={()=>setEditEvent(null)} className="cursor-pointer">
              Cancel
            </label>
          </div>
        </div>
